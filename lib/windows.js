...
function windows() {
	...
	const omniboxHwnd = user32.FindWindowExA(processHandle,activeWindowHandle, omniboxHwndBuffer, null)

	const windowURL = wchar.toString(omniboxHwndBuffer);

	console.log("omniboxHwnd", windowURL)
